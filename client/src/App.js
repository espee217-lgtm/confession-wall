...
function Navbar() {
  ...
  return (
    <header
      ...
      style={{
        backgroundImage:
          "linear-gradient(rgba(0,0,0,0.35), rgba(0,0,0,0.35)), url('/forest.png')",
...
function Footer() {
  return (
    ...
    >
      <Link to="/guidelines" style={{ margin: "0 12px", color: "#aaa" }}>
        Guidelines
      </Link>
      <Link to="/terms" style={{ margin: "0 12px", color: "#aaa" }}>
        Terms
      </Link>
      <Link to="/privacy" style={{ margin: "0 12px", color: "#aaa" }}>
        Privacy
      </Link>
    </div>
  );

...
const SHOP_ITEMS = [
  ...
  {
    id: "badge-petal-storm",
    type: "badge",
    name: "Petal Storm",
    description: "Sakura petals orbit a soft pink pulsing glow.",
    price: 120,
    icon: "🌸",
    rarity: "Rare",
    previewClass: "cw-cosmetic-badge-petal-storm",
  },
  {
    id: "badge-ember-core",
    type: "badge",
    name: "Ember Core",
    description: "Rising embers and a slowly rotating fiery border.",
    price: 200,
    icon: "🔥",
    rarity: "Epic",
    previewClass: "cw-cosmetic-badge-ember-core",
  },
  {
    id: "badge-void-sigil",
    type: "badge",
  ...
  },
  {
    ...
    type: "frame",
    name: "Moonveil Frame",
    description: "Silver moonlight gradient border with a gentle shimmer pulse.",
    price: 110,
    icon: "🌙",
    rarity: "Rare",
    previewClass: "cw-cosmetic-frame-moonveil",
  },
  {
    id: "frame-thornfire",
    type: "frame",
    name: "Thornfire Frame",
    description: "Creeping vine and ember halves with a rotating forest-red border.",
    price: 220,
    icon: "🥀",
    rarity: "Epic",
    previewClass: "cw-cosmetic-frame-thornfire",
  },
  {
    id: "frame-celestial",
    type: "frame",
  ...
  },
  {
    ...
    description: "A slow green shimmer sweeps across your display title.",
    price: 90,
    icon: "🌿",
    rarity: "Rare",
    previewClass: "cw-cosmetic-title-whisper-grove",
  },
  {
    id: "title-ashen-voice",
    type: "title",
    name: "Ashen Voice",
    description: "Your title glitches with ashen red-white splits.",
    price: 180,
    icon: "💨",
    rarity: "Epic",
    previewClass: "cw-cosmetic-title-ashen-voice",
  },
  {
    id: "title-eternal-bloom",
    type: "title",
    name: "Eternal Bloom",
    description: "A smooth cycling forest-gold-ember gradient title.",
    price: 400,
    icon: "🌺",
    rarity: "Legendary",
    previewClass: "cw-cosmetic-title-eternal-bloom",
  },
  {
    id: "post-theme-dewdrop-card",
    type: "postTheme",
    name: "Dewdrop Card",
    description: "Light green dew shimmer glides across your post card.",
    price: 100,
    icon: "💧",
    rarity: "Rare",
    previewClass: "cw-cosmetic-post-dewdrop",
  },
  {
    id: "post-theme-scorched-parchment",
    type: "postTheme",
    name: "Scorched Parchment Card",
    description: "Scorched parchment with drifting ember particles.",
    price: 190,
    icon: "📜",
    rarity: "Epic",
    previewClass: "cw-cosmetic-post-scorched-parchment",
  },
  {
    id: "post-theme-starbound-card",
    type: "postTheme",
    name: "Starbound Card",
    description: "Near-black sky with twinkling stars and indigo edge glow.",
    price: 420,
    icon: "🌠",
    rarity: "Legendary",
    previewClass: "cw-cosmetic-post-starbound",
  },
  {
  ...
  },
  {
    ...
    description: "A confession card theme for secrets whispered under a cold moon.",
    price: 280,
    icon: "\uD83C\uDF19",
    rarity: "Legendary",
  ...
  },
  {
    ...
    description: "A badge for silent watchers who carry their pain with style.",
    price: 165,
    icon: "\uD83D\uDC26\u200D\u2B1B",
    rarity: "Epic",
